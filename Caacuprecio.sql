...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2026 at 03:55 AM
...
(1, 'Computex', 'Computex ofrece las mejores ofertas, las mejores marcas y los mejores precios, Tecnología y seguridad a tu alcance, pedidos y envíos a todo el país.', 'https://computex.com.py/wp-content/uploads/2024/11/logocompletocomputex-1536x458.png', '-25.393026269447617, -57.14990553398656', 'https://computex.com.py/', '+595 982 607662', '0982 607662', 'computexpc@hotmail.com', 'Lunes		8:30 a.m. – 12:30 p.m.,	1:30 – 6 p.m.\r\nMartes		8:30 a.m. – 12:30 p.m.,	1:30 – 6 p.m.\r\nMiércoles	8:30 a.m. – 12:30 p.m.,	1:30 – 6 p.m.\r\nJueves		8:30 a.m. – 12:30 p.m.,	1:30 – 6 p.m.\r\nViernes		8:30 a.m. – 12:30 p.m.,	1:30 – 6 p.m.\r\nSábado		8:30 a.m. – 1 p.m.\r\nDomingo		Cerrado'),
(2, 'Inverfin', 'Inverfin S.A.E.C.A. es una empresa de Gente que Avanza con más de 20 años de dedicación, compromiso y trabajo. Se inició en el año 1996 en la ciudad de Coronel Oviedo en un pequeño local de venta de repuestos y motos. Actualmente cuenta con una moderna sede corporativa con una instalación acorde al negocio, con modernos sistemas de gestión y con tecnología de punta.', 'https://inverfin.com.py/cdn/shop/files/thumbnail_image.png?v=1755894019&width=480', '-25.38240094063622, -57.135378191862955', 'https://inverfin.com.py/', '+595 981 288828', '(021) 288 - 3000', 'cac@inverfin.com.py', 'Lunes		7:30 a.m. – 6 p.m.\r\nMartes		7:30 a.m. – 6 p.m.\r\nMiércoles	7:30 a.m. – 6 p.m.\r\nJueves		7:30 a.m. – 6 p.m.\r\nViernes		7:30 a.m. – 6 p.m.\r\nSábado		7:30 a.m. – 3 p.m.\r\nDomingo		Cerrado'),
(3, 'Full Office', 'Full Office S.R.L. es una empresa 100% paraguaya con sede en Caacupé – Cordillera que se dedica a la comercialización de productos, más de 19 años llevan como empresa y demuestra cabalmente su compromiso con el cliente a la hora de depositar su confianza.', 'https://www.fulloffice.com.py/storage/2025/02/Logo_fulloffice.svg', '-25.388011598949447, -57.14312940616084', 'https://www.fulloffice.com.py/', '+595 983 205782', '0511 242 100', 'info@fulloffice.com.py', 'Lunes		7:30 a.m. – 5:30 p.m.\r\nMartes		7:30 a.m. – 5:30 p.m.\r\nMiércoles	7:30 a.m. – 5:30 p.m.\r\nJueves		7:30 a.m. – 5:30 p.m.\r\nViernes		7:30 a.m. – 5:30 p.m.\r\nSábado		8 a.m. – 4 p.m.\r\nDomingo		Cerrado');
...
(2, 'Computex', 'computexpc@hotmail.com', '$2y$10$RunIM6ENPnrlcrZyuHUnLOSmngpFYjLru0ChqJzz8NE34Pu6bTBjW', 2, 1, NULL, NULL),
(3, 'Inverfin', 'cac@inverfin.com.py', '$2y$10$cbaORD4SzUDeYcBhcTEnJejzL.Q55hA56BAz.lV7/0makLTSlNnCG', 2, 2, NULL, NULL),
(4, 'Full Office', 'info@fulloffice.com.py', '$2y$10$B2.LL6NbAp3okW1iG0BlI.4tmG4vjPn7E1Fi9lLa.snKK3GA32LQm', 2, 3, NULL, NULL);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fk_usuarios_tiendas` (`tiendas_idtiendas`);
