...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2026 at 03:19 AM
...
CREATE TABLE IF NOT EXISTS `busquedas` (
  ...
  KEY `idx_bus_normalizado` (`bus_normalizado`),
  KEY `idx_bus_total` (`bus_total`),
  KEY `idx_bus_usuario` (`bus_usuario_id`)
...
CREATE TABLE IF NOT EXISTS `busqueda_click_producto` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_term` (`termino`),
  KEY `idx_producto` (`productos_idproductos`),
...
CREATE TABLE IF NOT EXISTS `favoritos` (
  ...
  KEY `idx_favoritos_producto` (`productos_idproductos`)
...
CREATE TABLE IF NOT EXISTS `historial_precios` (
  ...
  KEY `idx_historial_producto` (`productos_idproductos`)
...
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  UNIQUE KEY `uq_productos_url` (`pro_url`(255)),
  KEY `idx_productos_nombre` (`pro_nombre`),
  KEY `idx_productos_tienda` (`tiendas_idtiendas`),
  KEY `idx_productos_categoria` (`categorias_idcategorias`),
...
CREATE TABLE IF NOT EXISTS `productos_precios` (
  `proprecio_id` int(11) NOT NULL AUTO_INCREMENT,
  `productos_idproductos` int(11) NOT NULL,
  `tiendas_idtiendas` int(11) NOT NULL,
  ...
  PRIMARY KEY (`proprecio_id`),
  UNIQUE KEY `uq_precio_producto_tienda_url` (`productos_idproductos`,`tiendas_idtiendas`,`proprecio_url`(255)),
...
CREATE TABLE IF NOT EXISTS `productos_vistos` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vistos_usuario` (`usuario_idusuario`,`visto_en`),
  KEY `idx_vistos_session` (`session_id`,`visto_en`),
  KEY `idx_vistos_producto` (`productos_idproductos`,`visto_en`)
...
CREATE TABLE IF NOT EXISTS `producto_clicks` (
  ...
  PRIMARY KEY (`idclick`),
  KEY `idx_producto_clicks_producto` (`productos_idproductos`),
  KEY `idx_producto_clicks_usuario` (`usuario_idusuario`),
  KEY `idx_producto_clicks_session` (`session_id`),
  KEY `idx_producto_clicks_origen` (`click_origen`),
  KEY `idx_producto_clicks_tipo` (`click_tipo`)
...
CREATE TABLE IF NOT EXISTS `producto_reportes` (
  ...
  KEY `idx_producto` (`productos_idproductos`),
  KEY `idx_estado` (`rep_estado`),
  KEY `idx_fecha` (`rep_fecha`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `sugerencias` (
  ...
  KEY `idx_sug_estado` (`sug_estado`),
  KEY `idx_sug_fecha` (`sug_fecha`),
  KEY `idx_sug_session` (`sug_session_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'Chacomer', 'Chacomer es una empresa fundada por el Sr. Cornelius Walde en el año 1956. Con una cultura transparente de hacer negocios, basada en principios bíblicos que les guían, y fuertes valores como Integridad, Efectividad, Lealtad, espíritu Innovador y Responsabilidad Social Medioambiental, que les destacan y les permiten marcar pautas a seguir por toda la industria.', 'https://extractos.chacomer.com.py/assets/img/chacomer/chacomer_logo.png', '-25.385922958287978, -57.14344200004215', 'https://www.chacomer.com.py/', '+595 21 518 0000', '(021) 518 1882', 'cac@chacomer.com.py', 'Lunes		7 a.m. – 6 p.m.\r\nMartes		7 a.m. – 6 p.m.\r\nMiércoles	7 a.m. – 6 p.m.\r\nJueves		7 a.m. – 6 p.m.\r\nViernes		7 a.m. – 6 p.m.\r\nSábado		7 a.m. – 4 p.m.\r\nDomingo		Cerrado'),
(3, 'Tienda Gonzalito', '15 años siendo la solución en electrodomésticos, muebles y más. Financiación con mínimos requisitos, Amplia selección de electrodomésticos de las mejores marcas.', 'https://www.tiendagonzalito.com.py/assets_front/images/logo-con-border.png', '-25.384987837249938, -57.13990794250004', 'https://www.tiendagonzalito.com.py/', '+595 972 289900', '(021) 289 9000', 'ecommerce@tiendagonzalito.com.py', 'Lunes		7:30 a.m. – 5:30 p.m.\r\nMartes		7:30 a.m. – 5:30 p.m.\r\nMiércoles	7:30 a.m. – 5:30 p.m.\r\nJueves		7:30 a.m. – 5:30 p.m.\r\nViernes		7:30 a.m. – 5:30 p.m.\r\nSábado		7:30 a.m. – 4 p.m.\r\nDomingo		Cerrado'),
(4, 'Comfort House', 'En Comfort House, ofrecen todo lo que necesitas para el hogar con calidad, variedad de marcas y excelentes opciones de pago. Como parte de Consulting and Company SAECA, son una empresa minorista con 15 años de experiencia, en la venta de electrodomésticos, muebles, tecnología, calzados y moda deportiva.', 'https://files.catbox.moe/9nm6cd.png', '-25.387066164746294, -57.143220198033404', 'https://www.ch.com.py/', '+595 993 316000', '0993 316000', 'web@ch.com.py', 'Lunes		7:30 a.m. – 5:30 p.m.\r\nMartes		7:30 a.m. – 5:30 p.m.\r\nMiércoles	7:30 a.m. – 5:30 p.m.\r\nJueves		7:30 a.m. – 5:30 p.m.\r\nViernes		7:30 a.m. – 5:30 p.m.\r\nSábado		8 a.m. – 5 p.m.\r\nDomingo		Cerrado'),
...
CREATE TABLE IF NOT EXISTS `tienda_reviews` (
  ...
  KEY `idx_tienda_reviews_tienda` (`tiendas_idtiendas`),
  KEY `idx_tienda_reviews_fecha` (`rev_fecha`),
  KEY `idx_tienda_reviews_activo` (`rev_activo`)
...
CREATE TABLE IF NOT EXISTS `tienda_review_reportes` (
  `idreporte` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `rep_fecha` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`idreporte`),
  KEY `idx_review` (`reviews_idreview`),
  KEY `idx_estado` (`rep_estado`),
  KEY `idx_fecha` (`rep_fecha`),
  KEY `idx_session_review` (`rep_session_id`,`reviews_idreview`),
  KEY `idx_ip_review` (`rep_ip`,`reviews_idreview`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `tiendas_idtiendas` int(11) DEFAULT NULL,
  `usu_reset_token` varchar(64) DEFAULT NULL,
  `usu_reset_expira` datetime DEFAULT NULL,
  PRIMARY KEY (`idusuario`),
  UNIQUE KEY `uq_usuario_email` (`usu_email`),
  KEY `fk_usuarios_tiendas` (`tiendas_idtiendas`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `usuario` (`idusuario`, `usu_nombre`, `usu_email`, `usu_contra`, `usu_tipo`, `tiendas_idtiendas`, `usu_reset_token`, `usu_reset_expira`) VALUES
(1, 'Desushie', 'desushie@gmail.com', '$2y$10$2K9LZAv6KcTA/OTYzpMot.cUUCU5plpsk50agS3V/WbfSxQSv.oe2', 1, NULL, NULL, NULL),
(2, 'Computex', 'computexpc@hotmail.com', '$2y$10$RunIM6ENPnrlcrZyuHUnLOSmngpFYjLru0ChqJzz8NE34Pu6bTBjW', 2, 6, NULL, NULL),
(3, 'Inverfin', 'cac@inverfin.com.py', '$2y$10$cbaORD4SzUDeYcBhcTEnJejzL.Q55hA56BAz.lV7/0makLTSlNnCG', 2, 7, NULL, NULL),
(4, 'Full Office', 'info@fulloffice.com.py', '$2y$10$B2.LL6NbAp3okW1iG0BlI.4tmG4vjPn7E1Fi9lLa.snKK3GA32LQm', 2, 8, NULL, NULL),
(5, 'Comfort House', 'web@ch.com.py', '$2y$10$Yx.k51wn.v.kmMIdG7c.JuvhnMdI8p.R6Vz48BoOYHORm1xOuwD7G', 2, 4, NULL, NULL),
(6, 'Bristol', 'bristolteescucha@bristol.com.py', '$2y$10$0ScuGLWK15CIbqnFijggtet1I6.3PY8JuNHX5UEpruOprNAKnF3oi', 2, 5, NULL, NULL),
(7, 'Chacomer', 'cac@chacomer.com.py', '$2y$10$3LaFq8pFEOtSsujfmZOJH.E.59zuLd69oOyeONJYOsz2UnYoH/.I.', 2, 2, NULL, NULL),
(8, 'Tienda Gonzalito', 'ecommerce@tiendagonzalito.com.py', '$2y$10$mavNdzl9oHu9kfdu47p9Ye55ZWHTfKJ2NW/dkkrj1dTlkqhh8TZaG', 2, 3, NULL, NULL),
(9, 'Alex', 'info@alexsa.com.py', '$2y$10$Q0lj6d5CyPD7kR7QCnCc6O1BsTAgaUamgJGxMUQb9anaEGxqDGucO', 2, 1, NULL, NULL);
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_usuarios_tiendas` FOREIGN KEY (`tiendas_idtiendas`) REFERENCES `tiendas` (`idtiendas`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
