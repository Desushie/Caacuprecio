...
$params = [];
if ($q !== '') {
    $where[] = '(t.tie_nombre LIKE :q OR t.tie_descripcion LIKE :q OR t.tie_ubicacion LIKE :q)';
    $params[':q'] = '%' . $q . '%';
}
  ...
  <div class="container">
    ...
    <div class="admin-panel p-4 mb-4 admin-filter-bar">
      <form class="row g-3" method="get">
        <div class="col-lg-11">
          <input type="text" name="q" class="form-control" placeholder="Buscar por nombre, descripción o ubicación" value="<?= e($q) ?>">
        </div>
