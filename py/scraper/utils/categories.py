...
CATEGORY_ALIASES: Dict[str, str] = {
    # ---- Categorías maestras / variantes generales ----
    "accesorios": "Accesorios",
    "audio": "Audio",
    "bebes y juguetes": "Bebés y Juguetes",
    "camaras y seguridad": "Cámaras y Seguridad",
    "camaras de seguridad": "Cámaras y Seguridad",
    ...
    "smartwatch": "Celulares y Smartphones",
    "smartwatches": "Celulares y Smartphones",
    "relojes inteligentes": "Celulares y Smartphones",
    ...
    # ---- Inverfin: categorías reales, marcas, campañas y colecciones ----
    "0km samsung": "Productos",
    "accesorios de cocina": "Electrodomésticos",
    "accesorios de motos": "Motocicletas",
    "afeitadoras": "Salud y Belleza",
    "agosto liquida": "Productos",
    "aire fama": "Climatización",
    "aires": "Climatización",
    "aires acondicionados": "Climatización",
    "anafe": "Electrodomésticos",
    "anafes": "Electrodomésticos",
    "arizona": "Productos",
    "asadores": "Electrodomésticos",
    "athletic": "Deportes",
    "babyliss": "Salud y Belleza",
    "balanzas comerciales": "Electrodomésticos",
    "batidoras": "Electrodomésticos",
    "bebederos": "Electrodomésticos",
    "beko": "Electrodomésticos",
    "belleza": "Salud y Belleza",
    "bellisima week": "Salud y Belleza",
    "benelli": "Motocicletas",
    "bicicletas": "Deportes",
    "black especial": "Productos",
    "cafeteras": "Electrodomésticos",
    "centrifugadoras": "Electrodomésticos",
    "cepillos de pelo": "Salud y Belleza",
    "churrasquera hamburguesera": "Electrodomésticos",
    "cinta de caminar": "Deportes",
    "cobrador": "Productos",
    "cocina horno microondas diciembre": "Electrodomésticos",
    "cocinas": "Electrodomésticos",
    "cocinas y hornos": "Electrodomésticos",
    "combo imperdibles": "Productos",
    "combos salud y belleza": "Salud y Belleza",
    "complementos": "Accesorios",
    "congelador": "Electrodomésticos",
    "congelador consul": "Electrodomésticos",
    "congelador electrolux": "Electrodomésticos",
    "congelador fama": "Electrodomésticos",
    "congelador tokyo": "Electrodomésticos",
    "congeladores": "Electrodomésticos",
    "consul": "Electrodomésticos",
    "corta barba": "Salud y Belleza",
    "corta pelo": "Salud y Belleza",
    "cuidado capilar": "Salud y Belleza",
    "electro horno dia de la madre 1ro": "Electrodomésticos",
    "fama": "Productos",
    "high ticket": "Productos",
    "honor": "Celulares y Smartphones",
    "mega black belleza y cuidado": "Salud y Belleza",
    "mega black motos": "Motocicletas",
    "morbidelli": "Motocicletas",
    "moto": "Motocicletas",
    "motos": "Motocicletas",
    "motocicletas": "Motocicletas",
    "motos y accesorios": "Motocicletas",
    "moto carga": "Motocicletas",
    "moto taiga mawi": "Motocicletas",
    "motonetas": "Motocicletas",
    "nebulizadores": "Salud y Belleza",
    "reproductores": "Audio",
    "rizadores ondulares de pelo": "Salud y Belleza",
    "serie redmi xiaomi": "Celulares y Smartphones",
    "soportes para tv": "Accesorios",
    "tablet xiaomi": "Tablets",
    "teles 55": "TV y Video",

    # ---- Otras tiendas / variantes comunes ----
    "equipate": "Productos",
...
CATEGORY_KEYWORDS: Dict[str, List[str]] = {
    "Celulares y Smartphones": [
        ...
        "smartwatch", "smart watch", "reloj inteligente", "reloj", "watch"
    ],
    "Tablets": [
        "tablet", "ipad", "tab "
    ],
    ...
    "Electrodomésticos": [
        ...
        "cocina a gas", "cocina eléctrica", "congelador", "anafe",
        "placa de cocina", "placa infrarroja", "cocina infrarroja"
    ],
    "Climatización": [
    ...
    "Motocicletas": [
        "moto", "motos", "motocicleta", "motocicletas", "motoneta", "casco",
        "cubierta", "buler", "benelli", "taiga", "kenton", "leopard",
        "morbidelli"
    ],
    "Bebés y Juguetes": [
